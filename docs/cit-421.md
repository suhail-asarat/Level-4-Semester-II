...
- Book-1: [Fundamentals of I.]()
- Book-2: [Image Processing - The Fundamentals]()
- Book-3: [Principle of Digital Image Processing]()
- Book-4: [Pixels : Basis of all Image Processing]()
- Book-5: [Rafael C. Gonzalez, Richard E. Woods - Digital Image Processing (4th Edition)]()
...
### Chapter 8 : Image Compression and Watermarking (Book-5)
